...
export const resumeLink =
  "https://drive.google.com/file/d/1aEd9UbRvJlImMCrmEoZLj8dLYFO92lEm/view?usp=sharing";
export const repoLink = "https://github.com/ippandey/personal-portfolio";

export const callToAction =
  "https://www.linkedin.com/in/priyanshu-pandey-497347228/";
...
export const educationList = [
  {
    id: "education-1",
    icon: nits,
    title: "National Institute of Technology, Surat",
    degree: "Bachelor of Technology",
    duration: "December 2021 - May 2025",
    content1: "Pursuing B.Tech with a CGPA of 8.29/10.",
  },
  {
    id: "education-2",
    icon: vvs,
    ...
    content1: "Completed 12th grade in PCM with a percentage of 94%.",
  },
];
...
export const experiences = [
  {
    organisation: "Sanchita Enterprises, Surat",
    logo: logoSE,
...
export const extraCurricular = [
  {
    id: 1,
    organisation: "ACM, SVNIT",
    title: "Executive Member",
    duration: "September 2022 - May 2023",
    content: [
      {
        text: "Planned and conducted coding competitions, boosting student participation in competitive programming.",
        link: "",
      },
      {
        text: "Organised workshops on web3 and open-source development, enhancing students' skills and knowledge.",
        link: "",
      },
    ],
    logo: acm,
  ...
  {
    id: 2,
    organisation: "Google Developer Student Club, SVNIT",
    title: "Junior Developer",
    duration: "August 2022 - May 2023",
    content: [
      {
        text: "Spearheaded multiple open-source projects, mentored junior developers, and contributed to Google Winter of Code",
        link: "",
      },
      {
        text: "Developed reusable React components that were widely adopted in student projects, improving development efficiency.",
        link: "",
      },
    ],
    logo: gdsc,
  ...
  {
    id: 3,
    organisation: "CES, SVNIT",
    title: "Executive - Web Development",
    duration: "Sep 2022 - May 2023",
    content: [
      {
        text: "Led a team to develop and maintain the society’s website, ensuring seamless updates and event promotions",
        link: "",
      },
      {
        text: "Built an interactive event registration system, streamlining logistics and reducing manual errors.",
        link: "",
      },
    ],
    logo: ces,
  },
  {
    ...
    content: [
      {
        text: " Worked on real-world projects involving UI enhancements, state management, and API integrations.",
        link: "",
      },
    ],
    logo: freelancer,
  ...
  {
    id: 5,
    organisation: "E-Cell, SVNIT",
    title: "Executive Member",
    duration: "Sep 2022 - Apr 2023",
    content: [
      {
        text: "Organised the season 3 of the E-Cell SVNIT Podcast",
        link: "",
      },
      {
...
export const socialMedia = [
  {
    id: "social-media-1",
    icon: AiFillLinkedin,
    link: "https://www.linkedin.com/in/priyanshu-pandey-497347228/",
  },
  {
    id: "social-media-2",
    icon: AiFillGithub,
    link: "https://www.github.com/ippandey",
  },
  {
    id: "social-media-3",
    icon: AiFillMail,
    link: "mailto:priyanshu.p2025@gmail.com",
  },
  // {
  //   id: "social-media-4",
...
export const aboutMe = {
  ...
  githubUsername: "ippandey",
  tagLine:
    "SDE @NSE-India | ETHIndia'22,24 Winner | 8x Hackathon Winner | SVNIT'25 | Google DSC Lead",
  intro:
